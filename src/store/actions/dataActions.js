...
export const fetchDataById = (deviceId) => (dispatch, getState) => {
  ...
  axios
    .get("http://ec2-3-83-87-227.compute-1.amazonaws.com:8081/services/devicedataservice/api/sensor-data/all/" + deviceId, headerConfig(getState))
    .then(res => {
      dispatch({
...
export const fetchDeviceDetailById = (deviceId) => (dispatch, getState) => {
  ...
  axios
    .get("http://ec2-3-83-87-227.compute-1.amazonaws.com:8081/services/devicedataservice/api/device/" + deviceId, headerConfig(getState))
    .then(res => {
      dispatch({
